...
export default function TermsPage() {
  return <CommercialPage eyebrow="Termeni și condiții" title="Reguli simple pentru un spațiu de familie folosit cu grijă." description="Acești termeni explică materialele, livrarea digitală și regulile aplicabile comenzilor.">
    <section className="px-6 py-16 md:py-20"><div className="mx-auto max-w-5xl divide-y divide-brand-navy/15 border-y border-brand-navy/15 text-base font-medium leading-relaxed text-brand-navy/70">
      ...
      <section className="grid gap-4 py-8 md:grid-cols-[.55fr_1.45fr]"><h2 className="font-serif text-3xl text-brand-navy">Ce oferim</h2><p>Povestea Mea Magică oferă povești, ritualuri simbolice și activități digitale personalizate, individual sau într-un pachet cu trei materiale configurate separat. Rezultatul este creativ și poate varia. Te rugăm să verifici fiecare material înainte de a-l citi sau folosi împreună cu un copil.</p></section>
