...
export default function TermsPage() {
  return <CommercialPage eyebrow="Termeni și condiții" title="Reguli simple pentru un spațiu de familie folosit cu grijă." description="Acești termeni explică materialele, livrarea digitală și regulile aplicabile comenzilor.">
    <section className="px-6 py-16 md:py-20"><div className="mx-auto max-w-5xl divide-y divide-brand-navy/15 border-y border-brand-navy/15 text-base font-medium leading-relaxed text-brand-navy/70">
      ...
      <section className="grid gap-4 py-8 md:grid-cols-[.55fr_1.45fr]"><h2 className="font-serif text-3xl text-brand-navy">Plăți și comenzi</h2><div><p>Plățile online se activează în curând. Până atunci, poți crea și descărca materialele fără cost, fără cont de client și fără comandă cu plată.</p><p className="mt-4">La activarea plăților, înainte de confirmarea comenzii vei vedea prețul final, pașii de plată, livrarea digitală și condițiile aplicabile materialelor personalizate.</p></div></section>
