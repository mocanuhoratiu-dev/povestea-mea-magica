...
export default function TermsPage() {
  return <CommercialPage eyebrow="Termeni și condiții" title="Reguli simple pentru un spațiu de familie folosit cu grijă." description="Acești termeni explică ce oferim acum, ce poți face cu materialele și cum pregătim activarea comercială.">
    <section className="px-6 py-16 md:py-20"><div className="mx-auto max-w-5xl divide-y divide-brand-navy/15 border-y border-brand-navy/15 text-base font-medium leading-relaxed text-brand-navy/70">
      ...
      <section className="grid gap-4 py-8 md:grid-cols-[.55fr_1.45fr]"><h2 className="font-serif text-3xl text-brand-navy">Accesul de lansare</h2><div><p>În prezent, poți crea, previzualiza și descărca materialele fără plată. Nu există cont de client și nu se încheie prin site un contract de vânzare cu plată.</p><p className="mt-4">Prețurile afișate sunt prețuri planificate pentru lansarea comercială. Înainte de activarea plăților vom publica facturarea, pașii checkout-ului și condițiile aplicabile comenzilor cu plată.</p></div></section>
