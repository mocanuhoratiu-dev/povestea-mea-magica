...
export default function TermsPage() {
  return <CommercialPage eyebrow="Termeni și condiții" title="Reguli simple pentru un spațiu de familie folosit cu grijă." description="Acești termeni explică materialele, livrarea digitală și regulile aplicabile comenzilor.">
    <section className="px-6 py-16 md:py-20"><div className="mx-auto max-w-5xl divide-y divide-brand-navy/15 border-y border-brand-navy/15 text-base font-medium leading-relaxed text-brand-navy/70">
      <section className="grid gap-4 py-8 md:grid-cols-[.55fr_1.45fr]"><h2 className="font-serif text-3xl text-brand-navy">Cine oferă serviciul</h2><p><strong>{legalOperator.name}</strong>, CUI {legalOperator.cui}, nr. Registrul Comerțului {legalOperator.tradeRegisterNumber}, cu sediul social în {legalOperator.registeredOffice}. Pentru întrebări despre serviciu ne poți contacta la adresa de suport afișată mai jos.</p></section>
      <section className="grid gap-4 py-8 md:grid-cols-[.55fr_1.45fr]"><h2 className="font-serif text-3xl text-brand-navy">Plăți și comenzi</h2><div><p>Înainte de confirmarea comenzii vezi prețul final, pașii de plată, livrarea digitală și condițiile aplicabile materialelor personalizate. Plata este procesată securizat de furnizorul nostru de plăți.</p><p className="mt-4">După confirmarea plății, materialul personalizat intră în procesul de pregătire și este livrat digital conform informațiilor afișate în fluxul comenzii.</p></div></section>
      <section className="grid gap-4 py-8 md:grid-cols-[.55fr_1.45fr]"><h2 className="font-serif text-3xl text-brand-navy">Ce oferim</h2><p>Povestea Mea Magică oferă povești, albume ilustrate, ritualuri simbolice și activități digitale personalizate, individual sau în pachete. Rezultatul este creativ și poate varia. Te rugăm să verifici fiecare material înainte de a-l citi sau folosi împreună cu un copil.</p></section>
