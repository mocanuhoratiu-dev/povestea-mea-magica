...
const questions = [
  ["Ce primesc?", "Povestea Magică include o carte ilustrată de 16 pagini și un caiet separat de 5 pagini. Atelierul Scutului Magic are 13 pagini cu certificat, rețetă imaginară, poveste, fișa «Camera mea», card, calendar și audio Lumi. Dosarul Micului Explorator are 10 pagini cu 8 activități. Toate sunt personalizate și pregătite pentru print."],
  ...
  ["Pot printa materialele?", "Da. Povestea Magică și caietul de activități folosesc format A5 orizontal. Scutul și Trusa sunt pregătite pentru A4. Toate pot fi tipărite acasă sau la un centru de print."],
  ["Care sunt prețurile?", "Povestea Magică costă 59 lei. Atelierul Scutului Magic și Dosarul Micului Explorator costă câte 19 lei. Pachetul Complet le include pe toate la 79 lei, în loc de 97 lei. Prețul final este afișat înainte de plata securizată."],
