...
const questions = [
  ["Ce primesc?", "Primești unul sau două PDF-uri personalizate, în funcție de produs. Albumul Meu Magic include o carte ilustrată de 16 pagini și un caiet separat de 5 pagini, cu colorat, labirint și găsește diferențele. Povestea de Seară are copertă, dedicație și 2 sau 4 pagini de aventură, iar kiturile includ ritualurile și activitățile descrise înainte de comandă."],
  ["Este personalizat cu adevărat?", "Da. Alegerile despre copil, lume, lecție, context și interese schimbă povestea sau misiunile. Albumul folosește o Story Bible pentru coerența aventurii, iar personajul poate fi construit din descriere sau cu ajutorul unei fotografii opționale."],
  ["Cât durează?", "Materialele scurte sunt gata, de regulă, în mai puțin de un minut. Albumul ilustrat poate dura 6-10 minute, deoarece personajul, coperta, cele 13 scene și imaginile activităților sunt create separat la rezoluție mare."],
  ["Pot modifica ceva înainte de PDF?", "Da. Pentru Albumul Meu Magic vezi coperta personalizată înainte de plată, cu un watermark discret. Dacă schimbi alegerile sau fotografia, creezi un preview nou, iar coperta confirmată devine reperul vizual al personajului în album. Pentru Povestea de Seară poți edita textul înainte de descărcare și poți regenera coperta."],
  ...
  ["Care sunt prețurile?", "Povestea scurtă costă 19 lei, cea lungă 29 lei, iar fiecare kit costă 19 lei. Pachetul Familiei Magice costă 49 lei, iar Albumul Meu Magic costă 59 lei. Pachetul Complet costă 99 lei și le reunește pe toate în cinci PDF-uri."],
