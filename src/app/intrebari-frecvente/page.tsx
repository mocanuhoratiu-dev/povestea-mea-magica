...
export const metadata: Metadata = {
  ...
  description: "Răspunsuri despre personalizare, PDF-uri, livrare și accesul beta Povestea Mea Magică.",
...
const questions = [
  ...
  ["Care sunt prețurile?", "Prețurile planificate sunt 19 lei pentru povestea scurtă, 29 lei pentru povestea lungă și 19 lei pentru fiecare kit. Pachetul complet este 49 lei. În beta, nu există pas de plată."],
...
export default function FaqPage() {
  return <CommercialPage eyebrow="Întrebări frecvente" title="Lucrurile pe care e bine să le știi înainte să începi." description="Răspunsuri clare despre personalizare, PDF-uri, accesul beta și felul în care folosim datele introduse.">
