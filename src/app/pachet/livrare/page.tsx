...
export default function BundleDeliveryPage() {
  return (
    <CommercialPage eyebrow="Pachetul vostru" title="Toate materialele sunt gata." description="Deschide fiecare material și descarcă PDF-urile separat. Linkul personal rămâne valabil 30 de zile.">
