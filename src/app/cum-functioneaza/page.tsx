...
const steps = [
  { number: "01", title: "Alegi produsul", text: "Începi cu Povestea Magică, Atelierul Scutului Magic sau Dosarul Micului Explorator. Poți răsfoi pagini reale înainte să alegi.", icon: ListChecks },
