...
const steps = [
  ...
  { number: "03", title: "Verifici și îl folosiți", text: "Previzualizezi rezultatul, ajustezi ce dorești, apoi îl descarci ca PDF. Pentru poveste poți trimite PDF-ul și pe email.", icon: Download },
];
