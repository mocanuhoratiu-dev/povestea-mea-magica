...
export const metadata: Metadata = {
  title: "Povestea ta este gata | Povestea Mea Magică",
  robots: { index: false, follow: false },
};

export default function MagicalStoryDeliveryPage() {
  return (
    <>
      <main className="min-h-screen bg-brand-cream px-5 pb-20 pt-24 sm:px-6 md:pt-32">
        <section className="mx-auto max-w-5xl">
          <div className="border-b border-brand-navy/15 pb-9 text-center">
            ...
            <h1 className="mt-4 font-nunito text-4xl font-black leading-tight text-brand-navy sm:text-5xl">Povestea Magică este gata</h1>
