...
export const metadata: Metadata = {
  ...
  description: "16 pagini A5 orizontale, 13 scene ilustrate plus copertă, un caiet de activități. Vezi o mostră personalizată înainte de plată.",
  alternates: { canonical: "/povestea-magica" },
  openGraph: { url: "/povestea-magica", title: "Povestea Magică", description: "Copilul tău, într-o aventură numai a lui. Carte digitală și activități.", images: [{ url: "/social/og-povestea-magica.webp", width: 1200, height: 630 }] },
...
const productSchema = {
  ...
  image: [`${siteUrl}/examples/album/collection/coperta.webp`], description: "16 pagini, 13 scene ilustrate plus copertă, caiet separat de activități.",
...
export default function MagicalStoryPage() {
  return <main className="album-editorial">
    ...
    <section className="album-family-band"><div><p className="album-eyebrow">Nu doar numele pe copertă</p><h2>Detaliile mici fac<br/>povestea lor.</h2><p>O bicicletă albastră. Sora mai mare. Un rucsac drag. Tu ne spui ce contează, iar aventura începe de acolo.</p><LumiOpenButton label="Construim împreună cu Lumi" className="album-inline-link"/></div><ol aria-label="Cum creăm povestea"><li><b>01</b><div><h3>Îl cunoaștem pe erou</h3></div></li><li><b>02</b><div><h3>Alegeți aventura</h3></div></li><li><b>03</b><div><h3>Vedeți mostra, apoi decideți</h3></div></li></ol></section>
    ...
    <section className="album-included"><div><p className="album-eyebrow">Caietul poveștii · inclus în preț</p><h2>Povestea se termină.<br/>Joaca, nu.</h2><p>5 pagini A5 orizontale inspirate de aventura copilului: colorat, un labirint cu soluție și diferențe de descoperit. Cartea și caietul sosesc în PDF-uri separate, ca să imprimați doar paginile pentru joacă.</p><p>Pentru o aventură nouă la restaurant, pe drum sau în sala de așteptare, există <a href="/trusa-de-rabdare" className="underline underline-offset-4">Dosarul Micului Explorator</a>: un produs separat, cu 10 pagini, cartonașe și diplomă, adaptat locului și timpului disponibil.</p></div><Image src="/examples/album/collection/colorat.webp" alt="O pagină din caietul demonstrativ al Evei" width={960} height={676} sizes="(max-width: 700px) 90vw, 45vw"/></section>
    ...
    <section className="album-questions"><h2>Înainte de prima pagină</h2>{[
      ["Primesc o carte tipărită?", "În prezent primești ediția digitală: cartea PDF și caietul PDF. Variantele tipărite vor fi disponibile ulterior."],
