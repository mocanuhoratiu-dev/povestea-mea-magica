...
export default function Footer() {
  return (
    <footer data-site-footer className="site-footer bg-brand-navy px-6 pb-10 pt-20 text-brand-cream">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-10 border-b border-brand-cream/15 pb-10 md:grid-cols-[1.3fr_.8fr_.8fr]">
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex w-fit items-center gap-3">
              ...
              <span className="brand-wordmark">Povestea Mea <span>Magică</span></span>
            </Link>
            <p className="footer-signature">Povești. Curaj. Descoperiri.</p>
            <p className="mt-4 max-w-md text-base font-medium leading-relaxed text-brand-cream/70">Pentru seara în care mai citim o pagină. Și pentru toate micile momente dintre povești.</p>
            <div className="mt-8">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm font-semibold text-brand-cream/70">
              ...
              <li><Link href="/despre" className="transition-colors hover:text-brand-gold">Povestea noastră</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm font-semibold text-brand-cream/70">
              ...
              <li><Link href="/siguranta-ai" className="transition-colors hover:text-brand-gold">Siguranță și confidențialitate</Link></li>
              <li><Link href="/contact" className="transition-colors hover:text-brand-gold">Ajutor cu o comandă</Link></li>
            </ul>
          </div>
        </div>
