...
const products = [
  ...
  },
  {
    ...
    features: ["13 pagini cu două ilustrații originale", "Scut de construit, carduri și scrisoare", "Cele trei pagini clasice și audio Lumi"],
  ...
  },
  {
    ...
    features: ["10 pagini și un mister personalizat", "Labirint și diferențe validate", "Misiuni detașabile și 3 niveluri"],
