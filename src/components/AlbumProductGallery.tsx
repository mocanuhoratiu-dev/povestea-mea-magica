...
function ProductVisual({ visual }: { visual: (typeof items)[number]["visual"] }) {
  if (visual === "book") {
    return (
      <PremiumBookMockup src="/examples/album/coperta.webp" alt="Povestea Magică prezentată ca o carte ilustrată cu copertă tare" sizes="(min-width: 1024px) 30vw, 90vw" className="w-[96%]" />
    );
  }
    ...
    return (
      <div className="relative mx-auto aspect-[1.18] w-[92%]">
        <div className="absolute left-[8%] top-[12%] h-[72%] w-[58%] rotate-[-5deg] overflow-hidden border-[8px] border-brand-cream bg-brand-navy shadow-[0_18px_45px_rgba(6,15,34,.32)]">
          <Image src="/examples/album/flipbook/page-06.webp" alt="Pagină ilustrată redată pe telefon" fill sizes="26vw" className="object-contain" />
        </div>
        <div className="absolute bottom-[5%] right-[7%] h-[82%] w-[42%] overflow-hidden rounded-[24px] border-[7px] border-brand-navy bg-brand-navy shadow-[0_18px_45px_rgba(6,15,34,.38)]">
          <Image src="/examples/album/flipbook/page-01.webp" alt="Coperta poveștii pe telefon" fill sizes="18vw" className="object-contain" />
  ...
  return (
    <div className="relative mx-auto aspect-[1.18] w-[92%]">
      ...
      <div className="absolute inset-[2%_11%_10%_3%] -rotate-2 overflow-hidden border-[7px] border-white bg-white shadow-[0_20px_48px_rgba(6,15,34,.28)]">
        <Image src="/examples/album/colorat.webp" alt="Exemplu de pagină printată pentru colorat" fill sizes="28vw" className="object-contain" />
      </div>
      <div className="absolute bottom-[2%] right-[2%] h-[46%] w-[47%] rotate-3 overflow-hidden border-[6px] border-white bg-white shadow-[0_16px_34px_rgba(6,15,34,.3)]">
        <Image src="/examples/album/labirint.webp" alt="Exemplu de labirint inclus în caiet" fill sizes="20vw" className="object-contain" />
      </div>
    </div>
  );
}
