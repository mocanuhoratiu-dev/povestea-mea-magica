...
export default function MonsterKit() {
  ...
  return <section id="monster-away" className="relative overflow-hidden bg-brand-navy text-brand-cream">
    <div className="relative px-4 pb-16 pt-14 sm:px-6 md:pb-24 md:pt-20">
      ...
      <div className="mx-auto grid max-w-7xl gap-8 lg:min-h-[690px] lg:grid-cols-[.88fr_1.12fr] lg:items-center lg:gap-16">
        <div className="contents lg:block">
          ...
          <div className="flex items-end gap-4 border-y border-white/15 py-5 lg:mt-7"><div><p className="text-[10px] font-black uppercase tracking-[0.14em] text-brand-cream/70">Produs digital</p><p className="mt-1 font-nunito text-4xl font-black leading-none text-brand-gold">{commerce.prices.nightShield}</p></div><p className="max-w-[260px] pb-0.5 text-xs font-bold leading-relaxed text-brand-cream/72">9 pagini A4 și un ghid audio, livrate după personalizare.</p></div>
          ...
          <a id="configureaza-scutul-primary-cta" href="#configureaza-scutul" className="mt-8 inline-flex min-h-13 items-center bg-brand-gold px-6 text-sm font-black text-brand-navy transition hover:bg-brand-cream">Creează Scutul copilului<ArrowRight className="ml-2" size={18}/></a>
          </div>
        </div>
        <div className="relative order-2 mx-auto w-full max-w-[710px] pb-9 pt-2 lg:order-none lg:pb-10 lg:pt-4">
          <div aria-hidden="true" className="absolute inset-[16%_7%_4%_12%] bg-brand-purple/35 blur-3xl"/>
          <div className="relative mx-auto aspect-[.707] w-[52%] overflow-hidden border border-brand-gold/65 bg-brand-navy shadow-[18px_28px_65px_rgba(0,0,0,.4)] [transform:rotate(-3deg)] sm:w-[55%]"><Image unoptimized src="/examples/scut/certificat-hero.webp" alt="Certificatul personalizat din Scutul de Noapte" fill priority fetchPriority="high" sizes="(min-width: 1024px) 360px, 52vw" className="object-contain"/></div>
          <div className="absolute bottom-[2%] right-[1%] aspect-[.707] w-[43%] overflow-hidden border border-brand-gold/55 bg-brand-cream shadow-[14px_24px_50px_rgba(0,0,0,.36)] [transform:rotate(4deg)]"><Image unoptimized src="/examples/scut/etichete-hero.webp" alt="Etichetele detașabile din Scutul de Noapte" fill sizes="290px" className="object-contain"/></div>
