    ...
    <div className="relative px-4 pb-16 pt-14 sm:px-6 md:pb-24 md:pt-20">
      ...
      <div className="mx-auto grid max-w-7xl gap-8 lg:min-h-[690px] lg:grid-cols-[.88fr_1.12fr] lg:items-center lg:gap-16">
        ...
        <div className="relative order-2 mx-auto w-full max-w-[710px] pb-9 pt-2 lg:order-none lg:pb-10 lg:pt-4">
          ...
          <div className="relative mx-auto aspect-[.702] w-[52%] overflow-hidden border border-brand-gold/65 bg-brand-navy shadow-[18px_28px_65px_rgba(0,0,0,.4)] [transform:rotate(-3deg)] sm:w-[55%]"><Image unoptimized src="/examples/scut/certificat-hero.webp" alt="Certificatul personalizat din Scutul de Noapte" fill priority fetchPriority="high" sizes="(min-width: 1024px) 360px, 52vw" className="object-cover"/></div>
          <div className="absolute bottom-[2%] right-[1%] aspect-[.702] w-[43%] overflow-hidden border border-brand-gold/55 bg-brand-cream shadow-[14px_24px_50px_rgba(0,0,0,.36)] [transform:rotate(4deg)]"><Image unoptimized src="/examples/scut/etichete-hero.webp" alt="Etichetele detașabile din Scutul de Noapte" fill sizes="290px" className="object-cover"/></div>
